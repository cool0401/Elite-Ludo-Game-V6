...
public class GameConfigrationController : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        switch (GameManager.Instance.type)
        {
            case MyGameType.TwoPlayer:
                ...
                PlaybtnText.GetComponent<Text>().text = "Play";
            ...
            case MyGameType.Private:
                ...
                PlaybtnText.GetComponent<Text>().text = "Create Room";
    ...
    private void UpdateBid(bool changeBidInGM)
    {
        ...
        Debug.Log(StaticStrings.bidValues[currentBidIndex] + "current bid");
        if (changeBidInGM)
        {
            GameManager.Instance.payoutCoins = StaticStrings.bidValues[currentBidIndex];
            PlayerPrefs.SetInt("EN", StaticStrings.bidValues[currentBidIndex]);
            Debug.Log(StaticStrings.bidValues[currentBidIndex] + "current bid if condition");
        }
