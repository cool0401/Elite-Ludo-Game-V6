namespace AssemblyCSharp
{
    public static class StaticStrings
    {
        ...
        public static string AndroidPackageName = "com.eliteludo.webplustech";
        public static string ITunesAppID = "11111111111";

        // Notifications
        public static string notificationTitle = "Ludo Battle";
        public static string notificationMessage = "Get your FREE fortune spin!";

        public static string baseURL = "https://ludobattle.com/";
        ...
        public static string facebookShareLinkTitle = "I'm playing Ludo " +
            "Battle!. Available on Android and iOS.";

        // Share private room code
        public static string SharePrivateLinkMessage = "Join me in Ludo Battle. My Private Room Code is:";
        public static string SharePrivateLinkMessage2 = "Download Ludo Battle from:";
        public static string ShareApkLink = "https://ludobattle.com/";
        public static string ShareScreenShotText = "I finished game in Ludo Battle. It's my score :-) Join me and download Ludo Battle:";
